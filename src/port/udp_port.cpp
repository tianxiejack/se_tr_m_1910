...
static Int32 udp_port_open(struct _port_handle *Hdl, void *openParams);
static Int32 udp_port_close(struct _port_handle *Hdl);
static Int32 udp_port_send(struct _port_handle *Hdl, UInt8 *data, UInt32 len);
static Int32 udp_port_recv(struct _port_handle *Hdl, UInt8 *buffer, UInt32 size);
...
{
	udp_port_handle *udpPort = (udp_port_handle *)pHdl->context;
...
static Int32 udp_port_open(struct _port_handle *Hdl, void *openParams)
{
	...
	udp_port_handle *port = (udp_port_handle*)Hdl->context;
