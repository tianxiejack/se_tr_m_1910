...
class IPelcoDFormat : public AgreeMentBaseFormat
{
public:
	IPelcoDFormat(){
		ptzType = 0;//pelco_d;
	...
	void MakeCameraOn(agreement Ppkt, UINT8 byAddress = 0);
	 ...
	 void QueryZoomPos(agreement Ppkt, UINT8 byAddress = 0);
	 void QueryPanPos(agreement Ppkt, UINT8 byAddress = 0);
	 void QueryTiltPos(agreement Ppkt, UINT8 byAddress = 0);
	...
	// EXTENDED COMMANDS
	 ...
	 void MakeSetZoomPos(agreement Ppkt, UINT16 byValue, UINT8 byAddress /* = 0 */);
};
