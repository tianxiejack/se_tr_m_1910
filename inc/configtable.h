...
#define CFGID_INPUT_DETX(BKID)	CFGID_BUILD( BKID, 9 )
#define CFGID_INPUT_DETY(BKID)	CFGID_BUILD( BKID, 10 )
#define CFGID_INPUT_DETW(BKID)	CFGID_BUILD( BKID, 11 )
#define CFGID_INPUT_DETH(BKID)	CFGID_BUILD( BKID, 12 )
